    ...
    >
      <div className="container-main">
        <nav className="flex items-center justify-between h-32 md:h-36">
          ...
          <a
            href="#"
            className="flex items-center hover:opacity-80 transition-opacity flex-shrink-0 mt-8 md:mt-10"
          >
            <img
              ...
              alt="Rebelz AI"
              className="h-[106px] md:h-[122px] w-auto object-contain leading-none"
            />
          </a>
